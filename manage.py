...
# NOTE: just doing readlink `which dev_appserver.py` breaks if dev_appserver.py
#       isn't a symlink. No idea if this is the best way to solve this problem
#       but, here goes:
cmd = """
wda="`which dev_appserver.py`"
if [ -h "$wda" ]
then
    readlink $wda
else
